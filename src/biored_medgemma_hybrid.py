"""Selective MedGemma tie-breaker for the five-model BioRED ensemble.
...
from src.biored_candidate_gold import achievable_thresholds, build_vote_table, load_model_predictions
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run the selective MedGemma BioRED tie-breaker."
    )
